 ...
 *
 * STT: Deepgram Flux (primary), Vosk (fallback)
 * LLM: Ollama (self-hosted, overflow to Groq)
 * TTS: Kokoro-82M (primary), Piper (CPU fallback), UnrealSpeech/Groq (cloud)
 */
 ...
 * Fallback chain: kokoro -> piper (CPU, always available)
 */
